...
public class SinglyLinkedListTest {
	...
	public void singlyLinkedListRemoveFirstTest() {
		...
		lList1.removeFirst();
		assertEquals("lList1 head value should be 45.", new Integer(45), lList1.getHead().getValue());
		assertEquals("lList1 lastElement value should be 78.", new Integer(78), lList1.getLastElement().getValue());
	}

	@Test
	public void singlyLinkedListAddAsFirstTest() {
		// To empty list
		SinglyLinkedList lList1 = new SinglyLinkedList();

		lList1.addAsFirst(12);
		...
		lList1.addAsFirst(45);
		assertEquals("lList1 head value should be 45.", new Integer(45), lList1.getHead().getValue());
		assertEquals("lList1 head next value should be 12.", new Integer(12), lList1.getHead().getNext().getValue());
		assertNull("lList1 head next next should be null.", lList1.getHead().getNext().getNext());

		// To a list with more than one element

		lList1.addAsFirst(26);
		lList1.addAsFirst(55);
		assertEquals("lList1 head value should be 55.", new Integer(55), lList1.getHead().getValue());
		assertEquals("lList1 lastElement value should be 12.", new Integer(12), lList1.getLastElement().getValue());
	}
